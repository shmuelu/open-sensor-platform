...
namespace OSP {
    /** \brief represent the configuration of the system through a store of key/value pairs

        The big idea is a configuration should be constant throughout a run
        - Setter are private to prevent general setting of config items,
        - For testing purposes, or other controled usage of setting use friends.
        -  Friends should only populate items once and only on initialization
    */
...
public:
        ...
        /**
             ...
             */
        static const float *getConfigItemFloat( const char *const name, unsigned int *size );

        static const float *getNamedConfigItemFloat( const char *const name,
            const char *const property,
            unsigned int *size )
        {
        ...
        /**
             ...
             */
        static const int   *getConfigItemInt( const char *const name, unsigned int *const size );

        static const int   *getNamedConfigItemInt( const char *const name,
            const char *const property,
        ...
        static int getConfigItemIntV( const char *const name,
            const int default_value,
            int *const status );

        static int getNamedConfigItemIntV( const char *const name,
            const char *const property,
            const int default_value,
        ...
        static float getConfigItemFloatV( const char *const name,
        ...
        static float getNamedConfigItemFloatV( const char *const name,
            const char *const property,
            const float defaultValue,
            int *const status = NULL)
        {
        ...
        static bool getConfigItemBool( const char *const name, int *status = NULL)
        {
        ...
        /**
             ...
             */
        static int setConfigItem( const char *const name,
